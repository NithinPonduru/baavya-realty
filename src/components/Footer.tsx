        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mb-8 border-b border-slate-800 pb-8">
          <div className="max-w-md">
            ...
            <p className="text-sm text-slate-400 leading-relaxed mt-3">
              Buy premium apartments, villas & commercial properties in Hyderabad. Trusted real estate advisory by Satharla Bhanu Prakash Reddy — Manikonda, Kokapet, Kondapur & more.
            </p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="flex items-center gap-4">
              <a href="https://x.com/bhaavyarealty" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/5 backdrop-blur-xl flex items-center justify-center hover:bg-blue-400 transition-all duration-300 hover:scale-110 text-white" aria-label="X (Twitter)">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/bhaavyarealty.infra?utm_source=qr&igsh=ODU1eGlxOWxhaWY1" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/5 backdrop-blur-xl flex items-center justify-center hover:bg-pink-600 transition-all duration-300 hover:scale-110 text-white" aria-label="Instagram">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://wa.me/918179888986?text=Hi%20Bhanu%20Prakash%2CI%27ve%20gone%20through%20one%20of%20your%20projects%20and%20I%27m%20interested.%20Can%20we%20discuss%20further%3F" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/5 backdrop-blur-xl flex items-center justify-center hover:bg-green-500 transition-all duration-300 hover:scale-110 text-white" aria-label="WhatsApp">
